...
export default function App() {
  ...
  return (
    <div className="sara-app">
      ...
      {/* Main Viewport (Dynamically resizes & centers hero content and moon) */}
      <main className={`main-viewport ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
        {/* Moon & Planet Cosmic Layer anchored inside Main Viewport */}
        <CosmicBackground />
        ...
        <header className="main-header">
          ...
          <div className="header-right">
            {/* Independent Knowledge Base Control */}
            <button
            ...
            {/* Independent Audit & Evidence Control */}
            <button
              className="btn-header-pill"
              onClick={() => {
            ...
            <button
              ...
              onClick={() => alert('Upgrade to Sa-Ra AI Pro: Unlimited High-speed RAG & Multimodal models.')}
            >
              <SparkleIcon size={14} />
      ...
      {/* Independent Knowledge Base Drawer */}
      <KnowledgeBaseDrawer
        isOpen={kbDrawerOpen}
        onClose={() => setKbDrawerOpen(false)}
      />

      {/* Independent Audit & Evidence Drawer */}
      <AuditPanel
